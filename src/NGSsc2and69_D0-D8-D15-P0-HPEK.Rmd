...
#               add.cell.ids=c("P0", "HPEK", "D0", "D8", "D15"))
# 
# Aggr$orig.ident <- factor(x = Aggr$orig.ident, levels = c("D0", "D8", "D15", "P0", "HPEK"))
# 
# my.cols <- c("D0" = "#F8766D", 'D8'="#00C19A", 'D15' = "#ABA300", 'P0' = "#ED68ED", 'HPEK' = "#00A9FF")
...
# datatable(head(Aggr@meta.data, 20), class = "hover compact", 
#           options = list(pageLength = 5,
#                            initComplete = JS(
#     "function(settings, json) {",
#     "$(this.api().table().header()).css({'background-color': '#adc5e2', 'color': '#000'});",
#     "}"))) 

  #formatStyle(row = 1, color = "#adc5e2")
```
...
#saveRDS(Aggr.filt.norm, file = "./NGSsc02and69_Aggr-filt-norm_FC3000.rds")
...
#saveRDS(Aggr.filt.norm, "./NGSsc02and69_D0-D8-D15-P0-HPEK_seurat_afterClustering.rds")
```
...
#Aggr.filt.norm$orig.ident <- factor(x = Aggr.filt.norm$orig.ident, levels = c("D0", "D8", "D15", "P0", "HPEK"))
