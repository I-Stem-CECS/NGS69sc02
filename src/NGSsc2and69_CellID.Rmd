...
Aggr <- readRDS("./NGSsc02and69_D0-D8-D15-P0-HPEK_seurat_afterClustering.rds")
```
...
<!-- ```{r scHCL1, echo = TRUE, message = FALSE, warning = FALSE, fig.align = "center", dpi = 300} -->
...
<!-- hcl_result <- scHCL(scdata = hcl_lung, numbers_plot = 1) -->
<!-- scHCL_vis(hcl_result) -->

<!-- vargenes <- head(VariableFeatures(Aggr), 2000) -->
<!-- top2000 <- subset(Aggr, features = vargenes) -->
<!-- counts2000 <- as.matrix(top2000[["SCT"]]@counts ) -->
<!-- countsSCT <- as.matrix(Aggr[["SCT"]]@counts) -->

<!-- hcl_Aggr <- scHCL(scdata = counts2000, numbers_plot = 1) -->
<!-- scHCL_vis(hcl_Aggr) -->
